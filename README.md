...
open terminal and git clone the project into your local machine.
```
git clone https://github.com/koryr/money-transfer.git
...
## Authorization
#### Bearer Token
#### Token required for all the below endpoints
